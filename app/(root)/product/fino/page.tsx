          ...
          <div className="flex flex-col space-y-10">
            ...
            <div className="space-y-4">
              ...
              <ul className="list-disc list-inside text-black space-y-2">
                <li>
                  Ο ηλιακός θερμοσίφωνας EUROSTAR FINO έχει σχεδιαστεί για
                  μεγάλη απόδοση, διάρκεια ζωής και διακριτική εμφάνιση.
                </li>
                <li>
            ...
            <div className="space-y-4">
              ...
              <ul className="list-disc list-inside text-black space-y-2">
                <li>
                  Πλαίσιο από χυτό προφίλ αλουμινίου με ηλεκτροστατική βαφή,
                  χωρίς ραφές και βίδες για πλήρη στεγανότητα.
                </li>
                <li>
                ...
                <li>
                  Πρισματικό άθραυστο κρύσταλλο securit 4mm, 90,5%
                  διαπερατότητα.
                </li>
                <li>
